        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <span style="font-size: 24px;">Habitante de Calle</span>
                    <a href="{{route('unidadhabitantecalle.create')}}" class="btn btn-primary btn-sm" style="float: right;">Nuevo</a>
                </div>

                <div class="card-body">      
                    <table id="tblHabitanteCalle" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                            <th scope="col">#</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $habitante->documento }}</td>                               
                                <td>
                                  <a href="{{route('unidadhabitantecalle.show', $habitante->id)}}" class="btn btn-success btn-sm">Ver</a>                                    
